...
Open Browser To SignUp Page
    Open Browser    ${LOGIN_URL}    ${BROWSER}    --headless --disable-gpu --no-sandbox --disable-dev-shm-usage --window-size=1920,1080 --user-data-dir="${OUTPUT DIR}/edge-user-data-${TEST NAME}"
